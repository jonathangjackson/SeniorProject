Shader "Unlit/NewHologram"
{
	Properties
	{
		...
		_AlphaThreshold("Alpha Threshhold", Range(0,1.0)) = 1.0
	...
	SubShader
	{
		...
		Pass
		{
			...
			CGPROGRAM
				...
				half _Scale, _ScrollSpeedV, _GlowIntensity, _GlitchSpeed, _GlitchIntensity, _AlphaThreshold;
				...
				fixed4 fragmentFunc(v2f IN) : SV_Target{
					...
					return pixelColor * _Color * (rim + _GlowIntensity) * _AlphaThreshold;
				}
			ENDCG
		}
	}
